                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                              ...
                              <div class="check-form">
                                  <label><input type="checkbox" name="is_current" value="1" v-model="is_current">I currently work here</label>
                              </div>
                            </div>
                          </div>
                        </div>
...
export default {
		...
		getData()
    {
      ...
      const id = window.location.href.match(/edit_work_exp\/(.*)$/)[1];
      axios.get('/api/front/candidate/profile/getWorkExp/'+id).then(response => 
      {
		...
		submit() {
          ...
          formData.append('id',id);
				  axios.post('/api/front/candidate/profile/updateWorkExp/', formData).then(response => {
							$('.btnLoading').hide();
