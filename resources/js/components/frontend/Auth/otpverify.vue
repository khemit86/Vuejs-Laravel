               ...
               <div class="row no-gutters">
                  ...
                  <div class="col-md-5 col-left">
                     <div class="login-form-body">
                        ...
                        <h4 class="login-box-msg">Verify Your Account?</h4>
                        <div class="row g-3 login-form-left">
                           <div class="col-md-12 login-left">
                               <ValidationObserver v-slot="{ invalid }">
                              <form @submit.prevent="submit" ref="frm_otp">  
                                 <ValidationProvider rules="required" v-slot="{ errors }">                
                                 <div class="form-group has-feedback mb-3">
                                    <p>Enter the otp which recived by proslipsi to verify your account</p>
                                    ...
                                    <div class="help-block" style="color:red"  v-if="laravelErrors && laravelErrors.otp">
                                       <span>{{ laravelErrors.otp[0] }}</span>
                                    </div>                                 
                                 </div>
                                 </ValidationProvider>
                                 ...
                                 <div class="row">
                                    ...
                                    <!-- <p>By modifying your account, you agree to Proslipsi's Privacy Policy, Terms of Use and Use of Cookies.</p> -->
                                    </div>
                                 </div>
                              </form>
                               </ValidationObserver>
                        ...
                        <div class="col-md-12 login-right text-center mt-0">                   
                           ...
                           <div class="text-center d-flex align-items-center justify-content-center my-3">
                              <p class="login-text">Already have an account?<router-link class="" to="/login">Login Here</router-link></p>
                           </div>
                        </div>
                     </div>
                  </div>
...
export default {
   ...
   methods: {
      ...
      submit() {
               $('.btnLoading').show();
                this.laravelErrors = {};
                let formData = new FormData(this.$refs.frm_otp);
                axios.post('/api/front/verifyOtp', formData).then(response => {
                        this.fields = {}
                        $('.btnLoading').hide();       
