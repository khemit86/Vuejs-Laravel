               ...
               <div class="row no-gutters">
                  <div class="col-md-7 col-right">
                     <div class="find-job">
                        ...
                        <P class="job-s-title">Don't just think. ACT.</P>
                     </div>
                     <div class="svg-box">
                  ...
                  <div class="col-md-5 col-left">
                     <div class="login-form-body">
                        ...
                        <h4 class="login-box-msg">Sign in with Proslipsi Account</h4>
                        <div class="row g-3 login-form-left">
                           <div class="col-md-12 login-left">
                              <ValidationObserver v-slot="{ invalid }">
                              <form @submit.prevent="submit" ref="frm_login">                  
                                  <ValidationProvider rules="required|email" v-slot="{ errors }">
                                     <div class="form-group has-feedback mb-3">
                                       <input name="email" id="email" v-model="email" type="text" class="form-control" placeholder="Email">
                                 ...
                                 <div class="form-group has-feedback mb-3">
                                    ...
                                    <span class="view-pw" ><a href="#"><img data-id="1" id="imgConfirm" src="/../../img/ic_hide_24_dark.png"></a></span>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                       <button type="submit" class="btn browse-btn-fill w-100 my-3" :disabled="invalid">
                           ...
                           <div class="text-center d-flex align-items-center justify-content-center my-3">
                              <p class="mb-0">Don't have a Proslipsi account? 
                                 <router-link to="/candidate_register">
                              Register as Candidate</router-link>
                              </p>                              
                           </div>
                            <div class="or-btn">
                               <span>OR</span>
                           ...
                           <div class="text-center d-flex align-items-center justify-content-center my-3">
                              <p>
                                <router-link to="/employer_register">
                                     Register as Employer</router-link>
                              </p>                                                  
                           </div>

                                                    

                           <!-- <input type="text" class="abcd" placeholder="Selezione"> -->
...
export default {
      ...
      $(document).ready(function () 
        {
            ...
            $(".abcd").autocomplete({
               source:  {id: 1, name: 'Golden Retriever', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.'},
   ...
   methods: {
      ...
      submit() {
               $('.btnLoading').show();
                this.laravelErrors = {};
                let formData = new FormData(this.$refs.frm_login);
                var url = window.location.href.split('?').pop();
                axios.post('/api/front/loginPost?'+url, formData).then(response => {
                    $('.btnLoading').hide();
                        this.fields = {}
