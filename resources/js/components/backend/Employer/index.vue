      ...
      <admindashboard>
        <div class="content-header" slot="adminbody" style="margin-left:18%">
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Employer List</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">                  
                   <router-link to="/admin/employer/add" class="btn btn-success">
                   Add New Employer <i class="fas fa-user-plus"></i>
                  </router-link>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="data in dataEmployer.data" :key="data.id">
                      ...
                      <td>
                        ...
                        <router-link :to="'/admin/employer/edit/'+data.id" class="btn btn-info" style="color:#fff !important"><i class="fas fa-pen-alt"></i></router-link>                        
                        <router-link :to="'/admin/employer/view/'+data.id" class="btn btn-info" style="color:#fff !important"><i class="fas fa-eye"></i></router-link>
                        
                      </td>
                    </tr>              
                  </tbody>
                </table>
                <pagination align="right"   :data="dataEmployer"  @pagination-change-page="getEmployer" style="margin-top:2px;margin-right:4%">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row"> 
                <div class="col-md-6">
                  <label><input type="checkbox" class="chk" name="fields[company_name]" value="Company Name">Company Name</label>
                </div> 
                <div class="col-md-6">
                  <label><input type="checkbox" class="chk" name="fields[name]" value="Company Representative Full Name">Company Rep. Full Name</label>
                </div>              
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <label><input type="checkbox" class="chk" name="fields[country_id]" value="Country">Country</label>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <label><input type="checkbox" class="chk" name="fields[compnay_description]" value="Compnay Description">Company Description</label>
                  </div>
                </div>
...
<script>
    ...
    $('body').on('click','.showPDF',function(){
      ...
      methods: {
        ...
        getEmployer(page) {
           axios.get('/api/admin/employer/index?page='+ page+'&search='+this.search+'&start_date='+this.start_date+'&end_date='+this.end_date)
                .then( (response) => { 
        ...
        deleteCandidate(id){
          ...
          {
            axios.delete('/api/admin/employer/delete/'+id)
                .then( (response) => { 
        ...
        changeStatus(event, id){
          axios.get('/api/admin/employer/changeStatus/'+id)
              .then( (response) => { 
                this.flashMessage.success({                                   
        ...
        exportCandidate()
        {
            ...
            if(isSelect == 1)
            {
               let formData = new FormData(this.$refs.frm_export);
                axios.post('/api/admin/employer/export',formData)
                .then( (response) => { 
