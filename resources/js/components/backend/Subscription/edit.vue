        ...
        <section class="contener" slot="adminbody"  style="margin-left:20%;margin-right:1.5%">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" style="float:left">Edit Category</h3>
            ...
            {     
             ...
             methods: {                
                  getRecord() {
                        ...
                        axios.get('/api/admin/subscription/edit/'+id)
                        .then( (response) => { 
                            this.dataRecord = response.data;    
                            this.keyfeatures = response.data.key_fetures.split(",");         
                            this.fields = {
                                    title: this.dataRecord.title,
                                    amount: this.dataRecord.amount,
                                    post_visibility: this.dataRecord.post_visibility,                                
                                },
                                this.description =  this.dataRecord.description,
                ...
                axios.post('/api/admin/subscription/update/'+id,formData).then(response => {
